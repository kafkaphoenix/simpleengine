...
std::optional<std::string> StatsTracker::update(float deltaTime, const se::render::RenderStats& renderStats,
    ...
    case DisplayMode::Basic:
        stats = std::format(
            "{} FPS: {} RAM: {}/{}MB | Models: Draws {} Triangles {} | Animated Models: Draws {} Triangles {}", title,
            static_cast<int>(fps), mem.usedKB / 1024, mem.committedKB / 1024, renderStats.modelsDrawCalls,
